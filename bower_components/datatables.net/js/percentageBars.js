...
jQuery.fn.dataTable.render.percentBar = function(pShape, cText, cBorder, cBar, cBack, vRound, bType, iTotal) {
  ...
  return function(d, type, row) {
    ...
    s = ((parseFloat(d.toString().replace(/\s%|%/g,''))/iTotal)*100).toFixed(vRound);
    ...
    return '<div style="'+styleRule1+'"><div style="'+styleRule2+'"><div style="'+styleRule3+'width:'+s+ '%;"></div><div style="width:100%;text-align:center;position:absolute;left:0;top:0;">'+formatBytes(d)+'</div></div></div>';
  };
};
