...
public String generateRequestId(){
	//以【日期+時間+四位數隨機數】作為送給BSC API的 RequestId，例如【2011081610215362】
	java.text.SimpleDateFormat formatter = new java.text.SimpleDateFormat(gcDateFormatDateTime);
	java.util.Date currentTime = new java.util.Date();//得到當前系統時間
	String txtRandom = String.valueOf(Math.round(Math.random()*100));
	txtRandom = MakesUpZero(txtRandom, 2);	//不足4碼的話，將前面補0
